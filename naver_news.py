...
def get_naver_news():
    ...
    while True:
        ...
        sec_url = "https://news.naver.com/main/list.nhn?mode=LPOD&sid2=140&sid1=001&mid=sec&oid=001&isYeonhapFlash=Y&date={}&page={}".format(date,page)
        soup = get_soup_obj(sec_url)

        lis = soup.find('ul', class_='type02').find_all("li", limit=9)
